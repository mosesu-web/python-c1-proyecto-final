"""
Configuración de la app Flask para el servicio de gestión de citas
...
class Config:
    ...
    Attributes:
        ...
        USER_ADMIN_SERVICE_URL (str): Url interna para la comunicación entre servicios
    """

    JWT_SECRET_KEY: str = os.getenv("JWT_SECRET_KEY")
    JWT_EXPIRATION_DELTA: timedelta = timedelta(hours=1)
    SQLALCHEMY_DB_URI: str  = f"sqlite:///{os.getenv('APPOINTMENTS_DB_PATH')}"
    SQLALCHEMY_TRACK_MODIFICATIONS: bool = False
    DEBUG: bool = os.getenv("FLASK_DEBUG") == "1"
    PORT: int = int(os.getenv("APPOINTMENTS_PORT"))
    USER_ADMIN_SERVICE_URL: str  = os.getenv("USER_ADMIN_SERVICE_URL")
