...
def required_authorization(rol_requerido: list[str],
    ...
    El token que recibe es el token del usuario que recibe tras hacer el login
    Se usa para las peticiones de usuario a los endpoints de gestión de citas,
    es diferente al token que usa el servicio citas para acceder al servicio
    user-admin.
    ...
    def internal_decorator(f: Callable[..., Any]) -> Callable[..., Any]:
        ...
        def wrapper(*args: Any, **kwargs: Any):
            ...
            if return_payload:
                ...
                return f(rol_usuario= rol_usuario, user_id= user_id)
